...
<body>
  ...
  <div class="sidebar close">
    ...
    <li>
        <a href="char.php">
          <i class='bx bx-pie-chart-alt-2'> <br><span class="na">Impuestos</span></i>
      ...
      <li class="active" >
        <a href="ves.php">
          <i class='bx bx-pie-chart-alt-2'> <br><span class="n">Operatividad</span></i>
  ...
  src=" <?php echo $filas['operatividad'];  ?>" frameborder="0" allowFullScreen="true"></iframe>
